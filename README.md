...
## Specification
<ul>
    <li>System C Library: Musl </li>
    <li>Default C/C++ Compiler: clang </li>
    <li>Default linker: lld </li>
    <li>Default binary utilities: LLVM </li>
    <li>C++ standard library: libc++ </li>
    <li>C++ ABI library: libc++abi </li>
    <li>Unwinding Library: llvm-libunwind </li>
    <li>Init system: skarnet's S6 & S6-rc </li>
    <li>Device manager: Udev </li>
    <li>TLS Implementaion: OpenSSL </li>
    <li>System Shell: Bash </li>
    <li>System Gettext: GNU Gettext</li>
    <li>Curses Library: GNU Ncurses </li>
</ul>
